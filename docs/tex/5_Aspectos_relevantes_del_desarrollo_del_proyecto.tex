...
El  procedimiento seguido es directo y sencillo, mediante el uso de una semilla aleatoria, se asegura que todos los clasificadores y filtros poseen los mismos datos en cada \textit{n-ésima} iteración. El pseudocódigo se encuentra dispoible en el Algoritmo~\ref{alg:pseudo-exp}.
