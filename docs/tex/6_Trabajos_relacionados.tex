...
Tal y como se puede apreciar en la tabla~\ref{table:Comp-MLaaS}, existen numerosos servicios soportados por los principales proveedores de \textit{Machine Learning as a Service}, \textit{e.g.} todos ellos permiten el etiquetado de datos con técnicas de clasificación y regresión. 
