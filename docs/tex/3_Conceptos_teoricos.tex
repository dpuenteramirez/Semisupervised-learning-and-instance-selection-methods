...
\begin{center}
	...
	\rowcolor[HTML]{EFEFEF} 
	Algoritmo \textit{Drecremental Reduction Optimization Procedure} &~\cite{wilson2000reduction} \\ \bottomrule
	\end{tabular}
\end{center}
...
\Procedure{DROP3}{$X, k$}
	...
	\ForAll{$x \in S$}
		\State Encontrar los $x.N_{1\dots k+1}$, los $k+1$ vecinos más cercanos de $x$ en $S$
