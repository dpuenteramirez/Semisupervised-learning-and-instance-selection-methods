...
\begin{center}
	...
	\textbf{Método}    & \textbf{Referencia} \\
	\toprule
	Algoritmo de edición de Wilson (ENN)              &~\cite{wilson1972asymptotic}\\ 
	\rowcolor[HTML]{EFEFEF} 
	Algoritmo Condensado de Hart (CNN)              &~\cite{hart1968condensed}\\ 
	Algoritmo Condensado Reducido (RNN)              &~\cite{gates1972reduced}  \\ 
	\rowcolor[HTML]{EFEFEF} 
	Algoritmo \textit{Iterative Case Filtering} (ICF)                   &~\cite{brighton2002advances}\\ 
	Algoritmo Subconjunto Selectivo Modificado (MSS)                 &~\cite{barandela2005decision}\\ 
	\rowcolor[HTML]{EFEFEF} 
