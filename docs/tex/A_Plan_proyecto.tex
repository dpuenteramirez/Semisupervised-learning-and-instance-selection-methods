...
El IRPF es del XX\% y la retribución a la Seguridad Social, calculada tal cual se plantea en~\cite{ss_cotizacion} por el Ministerio de Empleo y Seguridad Social, se contribuye con un XX\% en total. Estando dividido en:
\begin{itemize}
\tightlist
\item XX\% de contingencias comunes.
\item XX\% por desempleo de tipo general.
\item XX\% destinado al Fondo de Garantía Salarial.
\item XX\% de formación profesional.
\end{itemize}
