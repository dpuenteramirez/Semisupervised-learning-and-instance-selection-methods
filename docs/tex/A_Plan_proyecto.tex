...
\begin{enumerate}
\item Mejora de la calidad del código de las librerías \texttt{IS-SSL}, principalmente reducir la complejidad cognitiva de los algoritmos de aprendizaje semi-supervisado.
