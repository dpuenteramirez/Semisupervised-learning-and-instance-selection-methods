...
\item Codificación de \textit{Co-Training} y \textit{Tri-Training}.
\end{enumerate}
\item \textbf{Marcas temporales}

El \textit{sprint} se desarrolla entre el dieciocho y el veintitrés de diciembre de dos mil veintiuno. Han sido dedicadas al desarrollo del proyecto XYZ horas. Este \textit{sprint} posee una duración más corta con el fin de ajustar las reuniones a las festividades propias de la Navidad.
