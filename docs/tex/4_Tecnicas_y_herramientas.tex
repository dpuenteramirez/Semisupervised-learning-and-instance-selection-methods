...
Permitiendo el modelado de modelado de diagramas UML (entre otros), dando soporte principalmente a:
\begin{itemize}
...
\item Diagrama de global de interacciones.
\end{itemize}
